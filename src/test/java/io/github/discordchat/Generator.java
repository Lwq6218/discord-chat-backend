...
public class Generator {
    ...
    private static final String USERNAME = "lwq";
    ...
    private static final String BASE_PACKAGE = "io.github.discordchat";
    ...
    private static final String DATABASE_NAME = "discordtest";
